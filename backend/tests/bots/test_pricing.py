...
from backend.services.bots.pricing import Pricing, create_pricing_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestPricing:
    """Test suite for Pricing Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_pricing_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "pricing"
        assert bot.name == "Pricing Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_pricing_bot(config={
...
class TestPricingIntegration:
    """Integration tests for Pricing Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_pricing_bot(config=config)
