"""
Tests for Calendar Bot (Office 365)
...
from backend.services.bots.calendar_office365 import CalendarOffice365, create_calendar_office365_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestCalendarOffice365:
    """Test suite for Calendar Bot (Office 365)"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_calendar_office365_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "calendar_office365"
        assert bot.name == "Calendar Bot (Office 365)"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_calendar_office365_bot(config={
...
# Integration tests
class TestCalendarOffice365Integration:
    """Integration tests for Calendar Bot (Office 365)"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_calendar_office365_bot(config=config)
