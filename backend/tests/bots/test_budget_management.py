"""
Tests for Budget Management Bot
...
from backend.services.bots.budget_management import BudgetManagement, create_budget_management_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestBudgetManagement:
    """Test suite for Budget Management Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_budget_management_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "budget_management"
        assert bot.name == "Budget Management Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_budget_management_bot(config={
...
class TestBudgetManagementIntegration:
    """Integration tests for Budget Management Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_budget_management_bot(config=config)
