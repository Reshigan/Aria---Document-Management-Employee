...
from backend.services.bots.cash_management import CashManagement, create_cash_management_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestCashManagement:
    """Test suite for Cash Management Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_cash_management_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "cash_management"
        assert bot.name == "Cash Management Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_cash_management_bot(config={
...
class TestCashManagementIntegration:
    """Integration tests for Cash Management Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_cash_management_bot(config=config)
