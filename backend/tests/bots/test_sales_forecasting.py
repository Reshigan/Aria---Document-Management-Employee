"""
Tests for Sales Forecasting Bot
...
from backend.services.bots.sales_forecasting import SalesForecasting, create_sales_forecasting_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestSalesForecasting:
    """Test suite for Sales Forecasting Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_sales_forecasting_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "sales_forecasting"
        assert bot.name == "Sales Forecasting Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_sales_forecasting_bot(config={
...
# Integration tests
class TestSalesForecastingIntegration:
    """Integration tests for Sales Forecasting Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_sales_forecasting_bot(config=config)
