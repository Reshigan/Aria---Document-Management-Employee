...
from backend.services.bots.tax_compliance import TaxCompliance, create_tax_compliance_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestTaxCompliance:
    """Test suite for Tax Compliance Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_tax_compliance_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "tax_compliance"
        assert bot.name == "Tax Compliance Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_tax_compliance_bot(config={
...
# Integration tests
class TestTaxComplianceIntegration:
    """Integration tests for Tax Compliance Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_tax_compliance_bot(config=config)
