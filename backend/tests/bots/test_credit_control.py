...
from backend.services.bots.credit_control import CreditControl, create_credit_control_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestCreditControl:
    """Test suite for Credit Control Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_credit_control_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "credit_control"
        assert bot.name == "Credit Control Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_credit_control_bot(config={
...
# Integration tests
class TestCreditControlIntegration:
    """Integration tests for Credit Control Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_credit_control_bot(config=config)
