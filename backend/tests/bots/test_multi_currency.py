...
from backend.services.bots.multi_currency import MultiCurrency, create_multi_currency_bot
from backend.services.bots.base_bot import BotStatus, BotPriority


class TestMultiCurrency:
    """Test suite for Multi-Currency Bot"""
    
    @pytest.fixture
    def bot(self):
        """Create bot instance for testing"""
        return create_multi_currency_bot(config={
            'batch_size': 10,
    ...
    def test_bot_initialization(self, bot):
        ...
        assert bot.bot_id == "multi_currency"
        assert bot.name == "Multi-Currency Bot"
    ...
    def test_error_handling(self, bot):
        ...
        invalid_bot = create_multi_currency_bot(config={
...
class TestMultiCurrencyIntegration:
    """Integration tests for Multi-Currency Bot"""
    ...
    def test_with_real_configuration(self):
        ...
        bot = create_multi_currency_bot(config=config)
