...
export default function Settings() {
  ...
  useEffect(() => {
    // Override global dark theme for settings page
  ...
  const renderSapConnectionTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">SAP System Connection</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">System Number</label>
            <input
              type="text"
      ...
      <div className="bg-blue-50 p-4 rounded-lg">
        ...
        <button className="mt-3 px-4 py-2 bg-blue-600 text-gray-900 rounded-lg hover:bg-blue-700 text-sm">
          Test Connection
        </button>
      </div>
    </div>
  ...
  const renderDocumentMappingsTab = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Document Type Mappings</h3>
        <p className="text-sm text-gray-600 mb-6">Configure how different document types are processed and posted to SAP.</p>
        <div className="space-y-6">
          {settings?.document_mappings && Object.entries(settings.document_mappings).map(([docType, mapping]) => (
            <div key={docType} className="bg-gray-50 border border-gray-200 rounded-lg p-6">
              <div className="flex items-center mb-4">
                ...
                <h4 className="font-medium text-gray-900 text-lg">{docType}</h4>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Standard Transaction</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Z Transaction (Custom)</label>
                  <input
                    type="text"
  ...
  const renderThresholdsTab = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">Configure confidence levels for document processing and automatic posting.</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h4 className="font-medium text-gray-900">Minimum Confidence Threshold</h4>
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Threshold Percentage</label>
            ...
            <p className="text-sm text-gray-600">Documents below this threshold will be flagged for manual review before processing.</p>
          </div>
          <div className="bg-green-50 border border-green-200 rounded-lg p-6">
            <div className="flex items-center mb-4">
              ...
              <h4 className="font-medium text-gray-900">Auto-Post Threshold</h4>
            </div>
            <div className="mb-4">
              <label className="block text-sm font-medium text-gray-700 mb-2">Threshold Percentage</label>
              <div className="flex items-center space-x-3">
            ...
            <p className="text-sm text-gray-600">Documents above this threshold can be automatically posted to SAP without manual review.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  const renderSystemSettingsTab = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mb-6">Additional system settings and preferences.</p>
        <div className="space-y-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            <h4 className="font-medium text-gray-900 mb-4">Processing Settings</h4>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <label className="font-medium text-gray-700">Enable Auto-Processing</label>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-600">Send email alerts for processing events</p>
                </div>
                <input type="checkbox" className="w-5 h-5 text-blue-600" defaultChecked />
              </div>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900" style={{background: "#f9fafb", color: "#111827"}}>
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900">ARIA Settings</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 flex justify-end">
          <button
            ...
            disabled={saving}
            className="bg-blue-600 text-gray-900 px-8 py-3 rounded-lg font-medium hover:bg-yellow-300 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
