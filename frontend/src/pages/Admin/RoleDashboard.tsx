            ...
            {[1, 2, 3, 4, 5].map((item) => (
              <div key={item} className="flex items-center justify-between py-2 border-b border-gray-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">Sales Order SO-{1000 + item}</p>
                    <p className="text-xs text-gray-500">Created 2 hours ago</p>
                  </div>
                </div>
                <span className="text-sm font-medium text-gray-900">R 12,450</span>
              </div>
            ))}
          </div>
        </div>
            ...
            {[
              ...
              <div key={index} className="flex items-center justify-between py-2 border-b border-gray-100">
                <div className="flex items-center">
                  ...
                  <div>
                    <p className="text-sm font-medium text-gray-900">{item.type}: {item.doc}</p>
