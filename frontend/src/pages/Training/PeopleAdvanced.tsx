...
const PeopleAdvanced: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Advanced Payroll Management', duration: '45 min', completed: false, locked: false },
    { id: '2', title: 'Benefits Administration', duration: '35 min', completed: false, locked: true },
    { id: '3', title: 'Talent Management', duration: '40 min', completed: false, locked: true },
    { id: '4', title: 'Workforce Planning', duration: '35 min', completed: false, locked: true },
    { id: '5', title: 'Employee Relations', duration: '30 min', completed: false, locked: true },
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>Advanced People & HR Training</Typography>
