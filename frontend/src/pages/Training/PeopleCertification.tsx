...
const PeopleCertification: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Certification Overview', duration: '15 min', completed: false, locked: false },
    { id: '2', title: 'Comprehensive HR Review', duration: '60 min', completed: false, locked: true },
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>People & HR Certification</Typography>
        <Chip label="Certification" color="primary" icon={<EmojiEvents />} />
      </Box>
      <Alert severity="info" sx={{ mb: 3 }}>Complete all modules to earn your HR Professional Certification.</Alert>
...
export default PeopleCertification;
