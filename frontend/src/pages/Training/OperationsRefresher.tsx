...
const OperationsRefresher: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Operations Updates 2026', duration: '20 min', completed: false },
    { id: '2', title: 'Process Improvements', duration: '15 min', completed: false },
    { id: '3', title: 'Safety & Compliance', duration: '15 min', completed: false },
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>Operations Refresher</Typography>
        <Chip label="Annual Refresher" color="info" icon={<Refresh />} />
      </Box>
      <Alert severity="warning" sx={{ mb: 3 }}>Your annual operations refresher is due. Complete all modules to maintain your certification.</Alert>
...
export default OperationsRefresher;
