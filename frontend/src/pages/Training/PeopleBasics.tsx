...
const PeopleBasics: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Introduction to HR Management', duration: '20 min', completed: true, locked: false },
    { id: '2', title: 'Employee Onboarding', duration: '25 min', completed: false, locked: false },
    { id: '3', title: 'Leave Management', duration: '20 min', completed: false, locked: true },
    { id: '4', title: 'Payroll Basics', duration: '30 min', completed: false, locked: true },
    { id: '5', title: 'Performance Management', duration: '25 min', completed: false, locked: true },
    { id: '6', title: 'HR Assessment', duration: '20 min', completed: false, locked: true },
  ]);
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>People & HR Basics Training</Typography>
