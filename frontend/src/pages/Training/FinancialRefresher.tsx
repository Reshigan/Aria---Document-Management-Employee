...
const FinancialRefresher: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Financial Updates 2026', duration: '20 min', completed: false },
    { id: '2', title: 'Tax Changes Review', duration: '15 min', completed: false },
    { id: '3', title: 'Reporting Best Practices', duration: '15 min', completed: false },
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>Financial Refresher</Typography>
        <Chip label="Annual Refresher" color="info" icon={<Refresh />} />
      </Box>
      <Alert severity="warning" sx={{ mb: 3 }}>Your annual financial refresher is due. Complete all modules to maintain your certification.</Alert>
...
export default FinancialRefresher;
