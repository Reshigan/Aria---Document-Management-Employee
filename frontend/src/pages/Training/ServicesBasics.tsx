...
const ServicesBasics: React.FC = () => {
  const [modules, setModules] = useState<Module[]>([
    { id: '1', title: 'Introduction to Service Management', duration: '20 min', completed: true, locked: false },
    { id: '2', title: 'Ticket Management', duration: '25 min', completed: false, locked: false },
    { id: '3', title: 'Customer Communication', duration: '20 min', completed: false, locked: true },
    { id: '4', title: 'SLA Fundamentals', duration: '25 min', completed: false, locked: true },
    { id: '5', title: 'Field Service Basics', duration: '30 min', completed: false, locked: true },
    { id: '6', title: 'Service Assessment', duration: '20 min', completed: false, locked: true },
  ]);
  ...
  return (
    <Box sx={{ p: 3, background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)', minHeight: '100vh' }}>
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Typography variant="h4" sx={{ color: 'white', fontWeight: 700 }}>Services Basics Training</Typography>
