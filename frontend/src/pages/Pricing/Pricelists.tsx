  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Manage pricing strategies with date ranges and customer segments</p>
      </div>

      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-white rounded-lg shadow p-4">
          <div className="text-sm text-gray-500">Total Pricelists</div>
          <div className="text-2xl font-bold text-green-600">{pricelists.length}</div>
        </div>
        <div className="bg-white rounded-lg shadow p-4">
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="text-sm text-gray-500">Default Pricelist</div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Customer Group</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredPricelists.map((pricelist) => (
                <tr key={pricelist.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{pricelist.currency}</td>
                  <td className="px-6 py-4">
                    {pricelist.customer_group_name ? (
                      <div className="flex items-center gap-2">
                        <Users size={14} className="text-gray-400" />
                        <span className="text-sm text-gray-600">{pricelist.customer_group_name}</span>
                      </div>
                    ) : (
                      <span className="text-sm text-gray-400">All Customers</span>
                    )}
                  </td>
                  <td className="px-6 py-4">
                    {pricelist.start_date || pricelist.end_date ? (
                      ...
                      <span className="text-sm text-gray-400">Always Valid</span>
                    )}
                  </td>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex flex-wrap gap-4">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-900">Default Pricelist</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="checkbox"
