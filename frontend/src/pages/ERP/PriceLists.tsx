          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              <label className="flex items-center space-x-2">
                ...
                />
                <span className="text-sm font-medium text-gray-700">Active Price List</span>
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-lg shadow-xl w-full max-w-6xl max-h-[90vh] overflow-y-auto">
          <div className="p-6 border-b border-gray-200 flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">{selectedPriceList.name}</h2>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Price List Details</h3>
                <dl className="space-y-2">
                  ...
                  {selectedPriceList.customer_name && (
                    <div>
                      ...
                      <dd className="text-sm text-gray-900">{selectedPriceList.customer_name}</dd>
                    </div>
                  )}
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Valid From</dt>
                    <dd className="text-sm text-gray-900">{new Date(selectedPriceList.valid_from).toLocaleDateString('en-ZA')}</dd>
                  </div>
                  {selectedPriceList.valid_to && (
                    <div>
                      <dt className="text-sm font-medium text-gray-500">Valid To</dt>
                      <dd className="text-sm text-gray-900">{new Date(selectedPriceList.valid_to).toLocaleDateString('en-ZA')}</dd>
                    </div>
                  )}
                  <div>
                    <dt className="text-sm font-medium text-gray-500">Priority</dt>
                    <dd className="text-sm text-gray-900">{selectedPriceList.priority}</dd>
                  </div>
                  <div>
              ...
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Add Price List Item</h3>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Price List Items ({priceListItems.length})</h3>
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-1">Manage pricing by customer, customer group, or promotional campaigns</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">{priceLists.length}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600 mt-1">{activePriceLists}</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500">Inactive Price Lists</p>
              <p className="text-3xl font-bold text-gray-600 mt-1">{inactivePriceLists}</p>
            </div>
