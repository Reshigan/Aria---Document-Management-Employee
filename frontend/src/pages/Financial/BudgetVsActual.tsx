                    ...
                    <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                      {report.by_account.map((account, idx) => (
                        <tr key={idx} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                          <td className="px-6 py-4"><div className="font-semibold text-gray-900 dark:text-white">{account.gl_account_code}</div><div className="text-xs text-gray-500 dark:text-gray-400">{account.gl_account_name}</div></td>
