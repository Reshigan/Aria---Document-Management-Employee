...
export default function QualityControlReport() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load statistics
      const statsResponse = await fetch(`${API_BASE}/api/agents/quality_control/statistics`, { headers });
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch(`${API_BASE}/api/agents/quality_control/activities`, { headers });
