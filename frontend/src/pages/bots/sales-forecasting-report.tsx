/**
 * Sales Forecasting Agent - Report Page
...
export default function SalesForecastingReport() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load statistics
      const statsResponse = await fetch(`${API_BASE}/api/agents/sales_forecasting/statistics`, { headers });
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch(`${API_BASE}/api/agents/sales_forecasting/activities`, { headers });
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" gutterBottom>
        Sales Forecasting Agent - Report
      </Typography>
