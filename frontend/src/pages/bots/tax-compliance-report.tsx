...
export default function TaxComplianceReport() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load statistics
      const statsResponse = await fetch(`${API_BASE}/api/agents/tax_compliance/statistics`, { headers });
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch(`${API_BASE}/api/agents/tax_compliance/activities`, { headers });
