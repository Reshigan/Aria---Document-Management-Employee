/**
 * Customer Onboarding Bot - Configuration Page
...
export default function CustomerOnboardingConfig() {
  ...
  const loadConfiguration = async () => {
    try {
      const response = await fetch('/api/bots/customer_onboarding/config');
  ...
  const handleExecute = async () => {
    try {
      const response = await fetch('/api/bots/customer_onboarding/execute', {
        method: 'POST'
      });
