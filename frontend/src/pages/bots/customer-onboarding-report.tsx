...
export default function CustomerOnboardingReport() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load statistics
      const statsResponse = await fetch(`${API_BASE}/api/agents/customer_onboarding/statistics`, { headers });
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch(`${API_BASE}/api/agents/customer_onboarding/activities`, { headers });
