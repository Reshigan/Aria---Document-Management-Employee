...
export default function CustomerOnboardingReport() {
  ...
  const loadData = async () => {
    try {
      // Load statistics
      const statsResponse = await fetch('/api/agents/customer_onboarding/statistics');
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch('/api/agents/customer_onboarding/activities');
