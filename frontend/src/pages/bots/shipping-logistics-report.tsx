...
export default function ShippingLogisticsReport() {
  ...
  const loadData = async () => {
    try {
      ...
      // Load statistics
      const statsResponse = await fetch(`${API_BASE}/api/agents/shipping_logistics/statistics`, { headers });
      const statsData = await statsResponse.json();
      setStats(statsData);
      
      // Load activities
      const activitiesResponse = await fetch(`${API_BASE}/api/agents/shipping_logistics/activities`, { headers });
