                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    <thead className="bg-gray-50 dark:bg-gray-900/50">
                      <tr>
                        <th className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400">Row</th>
                        {config.fields.slice(0, 5).map(field => (
                          <th key={field.name} className="px-4 py-3 text-left font-medium text-gray-500 dark:text-gray-400">
                            {field.label}
                          </th>
                        ))}
